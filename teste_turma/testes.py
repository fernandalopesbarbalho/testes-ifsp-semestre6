...
class turmaTest(unittest.TestCase):
  ...
  def testIntervalo(self):
    self.assertGreaterEqual(self.turmaObject.menorNota.nota, 0, "A nota não pode ser negativa")
    self.assertLessEqual(self.turmaObject.maiorNota.nota, 10, "A nota não pode ser maior que 10")
